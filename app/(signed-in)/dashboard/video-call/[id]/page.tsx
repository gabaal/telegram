...
import { Call, CallControls, CallingState, SpeakerLayout, useCallStateHooks } from "@stream-io/video-react-sdk"
...
function VideoCall() {
    ...
    if (callingState === CallingState.RECONNECTING) {
        return (
            <StatusCard title="Reconnecting..."
                description="Attempting to reconnect to the call."
                ...
                <div className="bg-white rounded-2xl p-8 max-w-lg w-full mx-4 shadow-2xl">
                    <div className="text-center space-y-6">
                        ...
                        <div className="space-y-2">
                            ...
                            <p className="text-gray-600">Share this link with others to invite them to the call</p></div>

                        <div className="bg-gray-50 rounded-lg p-4 border border-gray-200">
                            <div className="flex items-center gap-3">
                                <div className="flex-1 text-sm text-gray-700 font-mono break-all">{window.location.href}</div>
                                <button
                        ...
                        <p className="text-sm text-gray-500">Others can join using this link</p>
                    </div>
                </div>
            </div>
        )
