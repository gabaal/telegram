    ...
    <Dialog open={open} onOpenChange={handleOpenChange}>
        ...
        <DialogContent className="sm:max-w-[500px] max-h-[80vh] overflow-y-auto">
            ...
            <div className="space-y-4">
                <UserSearch onSelectedUser={handleSelectUser} className='w-full' />
                    ...
                    <div className="space-y-3">
                        ...
                        <div className="space-y-2 max-h-[200px] overflow-y-auto">
                            {selectedUsers.map((user) => (
                                <div key={user.userId} className="flex items-center justify-between p-2 bg-muted/50 border border-border rounded-lg">
                            ...
                            {selectedUsers.length > 1 && (
                                <div className="space-y-2">
                                    <label htmlFor="groupName" className="text-sm font-medium text-foreground">Group Name (Optional)</label>
                                    <input
                                        id="groupName"
                                        type='text'
                                        value={groupName}
                                    ...
                                    />
                                    <p className="text-xs text-muted-foreground">Leave empty to use default name: &quot;Group chat ( {selectedUsers.length+1} members)&quot;</p>
                                </div>
                            )}
                    </div>
                )}
                ...
                <DialogFooter>
                    ...
                    onClick={handleCreateChat}>
                        ...
                        {selectedUsers.length > 1 ? 'Create Group Chat' : selectedUsers.length === 1 ? 'Start Chat' : 'Create Chat'}
